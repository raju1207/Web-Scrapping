...
OLD_FILE = Path("data/mumbai_school_list.json")
FRESH_FILE = Path("data/udise_fresh_lists/mumbai_fresh.json")

REPORT_DIR = Path("data/audit")
REPORT_FILE = REPORT_DIR / "mumbai_fresh_list_comparison.json"
...
def main():
    ...
    print("=" * 76)
    print("UDISE+ MUMBAI SCHOOL LIST COMPARISON")
    print("=" * 76)
