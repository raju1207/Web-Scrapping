...
OLD_FILE = Path("data/chandigarh_school_list.json")
FRESH_FILE = Path("data/udise_fresh_lists/chandigarh_fresh.json")

REPORT_DIR = Path("data/audit")
REPORT_FILE = REPORT_DIR / "chandigarh_fresh_list_comparison.json"
...
def main():
    ...
    print("=" * 76)
    print("UDISE+ CHANDIGARH SCHOOL LIST COMPARISON")
    print("=" * 76)
