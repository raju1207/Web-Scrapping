...
LIST_FILE = Path("data/chandigarh_school_list.json")
RAW_DIR = Path("data/Chandigarh/2025-26")

REPORT_DIR = Path("data/audit")
REPORT_FILE = REPORT_DIR / "chandigarh_list_vs_raw_report.json"
...
def main():
    ...
    print("=" * 78)
    print("CHANDIGARH UDISE LIST VS RAW SCHOOL FILE AUDIT")
    print("=" * 78)
